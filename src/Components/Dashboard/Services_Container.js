  ...
  return (
    <div className="dashboard__container">
      ...
      <div className="services___btn-container">
        <div className="py-2 px-3 col-lg-6 col-xs-12 float-left">
          <Link
            to={{
              pathname: "/services",
              state: {
            ...
            className="btn btn-outline-primary col-lg-12"
            service="GPA"
          >
        ...
        <div className="py-2 px-3 col-lg-4 col-xs-12 float-left">
          <Link
            to={{
              pathname: "/services",
              state: {
      ...
      <div className="services___btn-container">
        <div className="py-2 px-3 col-lg-12 float-left">
          <Link
            to={{
              pathname: "/services",
              state: {
