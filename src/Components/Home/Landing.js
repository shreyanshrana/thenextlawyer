      ...
      <div>
        ...
        {this.state.showAuth ? (
          this.state.authMode == "login" ? (
            <Login hideAuth={this.hideAuth} />
          ) : (
            <Register hideAuth={this.hideAuth} />
          )
        ) : null}
        <div className="landing">
          ...
          <Search />
          <div className="landing__subtext display8 hide-desktop">
            Get started by
          </div>
          <a className="btn btn-primary landing__phone-btn hide-desktop display8">
            Create an account
          </a>
        </div>
        <div className="landing__services">
          ...
          <div className="col-lg-6 col-md-6 col-xs-12 float-left landing__services--button">
          ...
          <div className="col-lg-6 col-md-6 col-xs-12 float-left landing__services--button hide-phone">
            <a href="" className="btn btn-outline-primary col-12">
              Service 2
            </a>
          </div>
        ...
        <div className="landing__how-it-works clearfix" id="how-it-works">
          ...
          <div className="col-lg-4 col-xs-12 float-left landing__how-it-works--card-container">
            ...
            <div className="card text-center">
              ...
              <div className="card-body jumbotron__pricing--card-body">
                ...
                <div className="card-text ">
                  ...
                  your details which we embed into the templates to generate
          ...
          <div className="col-lg-4 col-xs-12 float-left landing__how-it-works--card-container">
            <div className="card text-center">
              ...
              <div className="card-body jumbotron__pricing--card-body">
                ...
                <div className="card-text ">
                  Once our process is complete, the system generates your
                  desired documents for you to download and print however many
