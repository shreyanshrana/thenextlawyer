    ...
    return (
      <React.Fragment>
        ...
        <BrowserRouter>
          ...
          <React.Fragment>
            <AuthContext.Provider value={{token: this.state.token, userId: this.state.userId, userInfo: this.state.userInfo, login: this.login, setUserInfo: this.setUserInfo, logout: this.logout}}>
              <Switch>
                { !this.state.token ? <Redirect from='/dashboard/services' to='/' /> : (null) }
